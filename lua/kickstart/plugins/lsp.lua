	...
	config = function()
		...
		vim.api.nvim_create_autocmd('LspAttach', {
			...
			callback = function(event)
				...
				map('<leader>i', vim.lsp.buf.hover, 'Display Hover Information')
				...
				map('<leader>D', Snacks.picker.lsp_type_definitions, 'Goto T[y]pe Definition')
				...
				map('<leader>ds', function() Snacks.picker.lsp_symbols(kind_filter) end, 'Symbols')

				-- Fuzzy find symbols in the workspace
				map('<leader>ws', function() Snacks.picker.lsp_workspace_symbols(kind_filter) end, 'Workspace Symbols')
